...
Test-PathOk "extract_frames.py"   (Join-Path $PipelineDir "scripts\extract_frames.py")
Test-PathOk "classify_frames.py"  (Join-Path $PipelineDir "scripts\classify_frames.py")
Test-PathOk "crop_pizza_images.py"(Join-Path $PipelineDir "scripts\crop_pizza_images.py")
Test-PathOk "mark_processed.py"   (Join-Path $PipelineDir "scripts\mark_processed_videos.py")
Test-PathOk "upload_frames.js"    (Join-Path $PipelineDir "scripts\upload_selected_frames.js")
Test-PathOk "upload_sheets.js"    (Join-Path $PipelineDir "scripts\upload_to_sheets.js")
